"""
Generate Ad Mockups for Lead Faucet
...
def generate_meta_mockup(
    ...
    description: str = "",
    cta: str = "Learn More",
    display_link: str = "leadfaucet.io",
) -> Image.Image:
    """
...
async def process_record(
    ...
    display_link = fields.get(field_map.get("display_link", "Display Link"), "leadfaucet.io")
...
async def main():
    parser = argparse.ArgumentParser(description="Generate ad mockups for Lead Faucet")
    ...
    print("[*] Loading Lead Faucet configuration...")
