# Lead Faucet Environment Variables

Create a `.env` file in this directory with:

```
# Airtable Personal Access Token for Lead Faucet base
...
1. **Personal Access Token:**
   ...
   - Add access to your Lead Faucet base

2. **Base ID:**
   - Open your Lead Faucet base in Airtable
