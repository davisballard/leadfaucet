# Lead Faucet - Creative Ideation Process

> Brand-specific creative workflow for PI lead generation ads.
> 
> This file extends the core `SKILL.md` with Lead Faucet context.
> 
...
**Lead Faucet** generates leads for personal injury law firms, focusing on motor vehicle accidents (MVA). The strategy emphasizes:
...
Reference: `05_Dept_Compliance/Saul.md` for full rulebook.
