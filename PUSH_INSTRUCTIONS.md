# How to Push Lead Faucet to GitHub
...
1. ✅ Syncs your Lead_Faucet folder to `~/leadfaucet-repo/`
2. ✅ Excludes: `.venv`, `.env`, `__pycache__`, `.pyc` files
3. ✅ Commits with timestamp
4. ✅ Force pushes to: https://github.com/davisballard/leadfaucet.git
...
**Takes too long**
→ Large audio/image files take time to upload. First push was 51MB and took ~17 minutes.

---

*Script location: `Agency_Simulation_Root/06_Brands/Lead_Faucet/push-leadfaucet.sh`*
